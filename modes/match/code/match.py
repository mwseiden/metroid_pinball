...
class MyMatch(Match):
    ...
    def no_match(self, **kwargs):
        show_tokens = dict(match_number0=kwargs.get('match_number0', ''), match_number1=kwargs.get('match_number1', ''), match_number2=kwargs.get('match_number2', ''), match_number3=kwargs.get('match_number3', ''), winner_number=kwargs.get('winner_number', ''))
